...
/* package props-0.1.0.0 */
#ifndef VERSION_props
#define VERSION_props "0.1.0.0"
#endif /* VERSION_props */
#ifndef MIN_VERSION_props
#define MIN_VERSION_props(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_props */
...
#define CURRENT_COMPONENT_ID "props-0.1.0.0-inplace-props"
